...
echo ===================================================
echo Kairos Intelligence System - Demo de Monitor de Agentes LangChain
echo ===================================================
...
"%python_exe%" examples/langchain_monitor_demo.py

if %ERRORLEVEL% neq 0 (
    echo.
    echo Error al ejecutar la demostración. Código de error: %ERRORLEVEL%
    pause
    exit /b %ERRORLEVEL%
)
