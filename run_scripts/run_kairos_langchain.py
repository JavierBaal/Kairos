#!/usr/bin/env python3
"""
Kairos Intelligence System - Launcher Script (LangChain Version)
Este script inicia la aplicación Kairos Intelligence System usando LangChain.
"""
...
def check_python_version():
    ...
    if python_version.major < 3 or (python_version.major == 3 and python_version.minor < 9):
        ...
        print("  LangChain requiere Python 3.9 o superior.")
...
def check_dependencies():
    ...
    if not check_python_version():
        print("\nDebes actualizar Python a la versión 3.9 o superior para usar LangChain.")
...
def install_dependencies(missing_deps=None):
    ...
    if missing_deps:
        ...
        # Instalar todas las dependencias desde requirements_langchain.txt
        try:
            requirements_path = os.path.join("..", "config_files", "requirements_langchain.txt")
            subprocess.check_call([sys.executable, "-m", "pip", "install", "-r", requirements_path])
            print("✓ Todas las dependencias instaladas correctamente")
            return True
        except subprocess.CalledProcessError:
            print("✗ Error al instalar dependencias desde requirements_langchain.txt")
...
def main():
    """Función principal"""
    print("=== Kairos Intelligence System (LangChain) ===")
    ...
    if not deps_ok:
        if "python-upgrade" in missing_deps:
            ...
            print("\nDetectada versión de Python incompatible con LangChain.")
            print("Puedes ejecutar Kairos en modo básico que no requiere LangChain")
            print("o actualizar Python a la versión 3.9 o superior para acceder a todas las funcionalidades.")
